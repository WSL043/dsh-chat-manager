// Modified from @deepseek-ai/dsh-client-ui-workspace 0.1.0-rc.6 by DSH Session Delete. See THIRD_PARTY_NOTICES.md.
	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"delete.session.desc": "“{name}”的会话记录将从本机永久删除，且无法恢复。正在运行或本次已打开的会话不会被删除。",
		...
		const en = {
			...
			"delete.session.desc": "The local record for “{name}” will be permanently deleted and cannot be recovered. Running or already-opened sessions are refused.",
