// Modified from @deepseek-ai/dsh-client-ui-workspace 0.1.6-alpha.2 by DSH Chat Manager. See THIRD_PARTY_NOTICES.md.
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$2 = "dsh-chat-manager/Rows.module.css";
		...
		*/
		...
		const tagId$1 = "dsh-chat-manager/WorkspacePicker.module.css";
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)(WorkspacePickFlow, {
								...
								createWorkspace,
								useDirectoryFlow,
								renderDirectoryFlow: (owner) => renderSlot("dsh-chat-manager.directoryFlow", owner),
								addOnly: true,
								side: "right",
								onPick: (workspaceId) => {
									setWsPickerOpen(false);
		...
		*/
		...
		const NS = "dsh-chat-manager-workspace";
		/**
...
(function mirrorDirectoryFlow(ctx) {
  ...
  ctx.slots.inject(source, () => ctx.slots.inject(target, () => {
    ...
    return () => { unsubscribe(); clear() }
			...
			// Root hooks remain owned by the official workspace.
			...
			const browserFlowSource = flowSource("dsh-chat-manager.directoryFlow");
			const hostInfo = {
			...
			ctx.slots.inject("sidebar.workspaces", () => ctx.slots.register({
                ...
                priority: -10,
				children: { "dsh-chat-manager.directoryFlow": {
					kind: "single",
					scope: "root"
				} },
