// DSH Chat Manager runtime-compatible client: stable, preview, and modern implementations are selected by concrete host capabilities.
window.__ModuleLoader__.load({
	id: "dsh-chat-manager",
	factory: (require) => {
		const stableFactory = (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:@deepseek-ai/dsh-client-ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".dcmRows_projectRow,.dcmRows_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.dcmRows_projectRow:hover,.dcmRows_sessionRow:hover,.dcmRows_sessionRow.dcmRows_selected{background:var(--dsw-alias-interactive-bg-hover)}.dcmRows_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.dcmRows_searchResultRow:hover,.dcmRows_searchResultRow.dcmRows_selected{background:var(--dsw-alias-interactive-bg-hover)}.dcmRows_searchResultHeading{align-items:center;min-width:0;display:flex}.dcmRows_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.dcmRows_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.dcmRows_searchResultWorkspace,.dcmRows_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.dcmRows_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.dcmRows_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.dcmRows_projectRow{box-sizing:border-box;align-items:center;height:34px}.dcmRows_projectRow .dcmRows_rowActions{height:20px}.dcmRows_sessionRow{height:32px;animation:dcmRows_row-in .15s var(--ds-ease-in-out);gap:0}.dcmRows_sessionRow .dcmRows_title{margin:0 6px 0 4px}.dcmRows_flatSessionRowWithoutStatus .dcmRows_title{margin-left:0}@keyframes dcmRows_row-in{0%{opacity:0}}.dcmRows_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.dcmRows_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.dcmRows_folderActive{color:var(--dsw-alias-state-business-primary)}.dcmRows_projectRow .dcmRows_chevron{display:none}.dcmRows_projectRow:hover .dcmRows_chevron{display:inline-flex}.dcmRows_projectRow:hover .dcmRows_folder{display:none}.dcmRows_arrow{transition:transform .15s var(--ds-ease-in-out)}.dcmRows_arrowOpen{transform:rotate(90deg)}.dcmRows_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.dcmRows_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.dcmRows_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.dcmRows_sessionRow .dcmRows_title{flex:1}.dcmRows_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.dcmRows_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.dcmRows_dot{flex:none}.dcmRows_rowActions{flex:none;align-items:center;gap:12px;display:none}.dcmRows_projectRow:hover .dcmRows_rowActions,.dcmRows_sessionRow:hover .dcmRows_rowActions,.dcmRows_projectRow.dcmRows_menuOpen .dcmRows_rowActions,.dcmRows_sessionRow.dcmRows_menuOpen .dcmRows_rowActions{display:inline-flex}.dcmRows_sessionRow:hover .dcmRows_time,.dcmRows_sessionRow.dcmRows_menuOpen .dcmRows_time{display:none}.dcmRows_projectRow.dcmRows_menuOpen,.dcmRows_sessionRow.dcmRows_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.dcmRows_sessionRow.dcmRows_dropBefore,.dcmRows_sessionRow.dcmRows_dropAfter{position:relative}.dcmRows_sessionRow.dcmRows_dropBefore:before,.dcmRows_sessionRow.dcmRows_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.dcmRows_sessionRow.dcmRows_dropBefore:before{top:-7px}.dcmRows_sessionRow.dcmRows_dropAfter:after{bottom:-7px}.dcmRows_hoverContent{flex-direction:column;gap:8px;display:flex}.dcmRows_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.dcmRows_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.dcmRows_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.dcmRows_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.dcmRows_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.dcmRows_iconButton:hover{color:var(--dsw-alias-label-primary)}.dcmRows_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.dcmRows_sessionRow,.dcmRows_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "dcmRows_arrow",
			"arrowOpen": "dcmRows_arrowOpen",
			"chevron": "dcmRows_chevron",
			"dot": "dcmRows_dot",
			"dropAfter": "dcmRows_dropAfter",
			"dropBefore": "dcmRows_dropBefore",
			"flatSessionRowWithoutStatus": "dcmRows_flatSessionRowWithoutStatus",
			"folder": "dcmRows_folder",
			"folderActive": "dcmRows_folderActive",
			"hoverContent": "dcmRows_hoverContent",
			"hoverPath": "dcmRows_hoverPath",
			"hoverStatus": "dcmRows_hoverStatus",
			"hoverTime": "dcmRows_hoverTime",
			"hoverTitle": "dcmRows_hoverTitle",
			"iconButton": "dcmRows_iconButton",
			"menuOpen": "dcmRows_menuOpen",
			"meta": "dcmRows_meta",
			"projectRow": "dcmRows_projectRow",
			"projectText": "dcmRows_projectText",
			"renameInput": "dcmRows_renameInput",
			"row-in": "dcmRows_row-in",
			"rowActions": "dcmRows_rowActions",
			"searchResultHeading": "dcmRows_searchResultHeading",
			"searchResultMeta": "dcmRows_searchResultMeta",
			"searchResultRow": "dcmRows_searchResultRow",
			"searchResultSnippet": "dcmRows_searchResultSnippet",
			"searchResultTitle": "dcmRows_searchResultTitle",
			"searchResultWorkspace": "dcmRows_searchResultWorkspace",
			"selected": "dcmRows_selected",
			"sessionRow": "dcmRows_sessionRow",
			"slot": "dcmRows_slot",
			"time": "dcmRows_time",
			"title": "dcmRows_title",
			"visuallyHidden": "dcmRows_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:@deepseek-ai/dsh-client-ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".dcmPicker_modalAction{min-width:72px}.dcmPicker_modalError,.dcmPicker_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.dcmPicker_modalError{color:var(--dsw-alias-state-error-primary)}.dcmPicker_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "dcmPicker_menuStatus",
			"modalAction": "dcmPicker_modalAction",
			"modalError": "dcmPicker_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:@deepseek-ai/dsh-client-ui-workspace/src/client/WorkspaceBrowser.module.css.mjs
		const css = ".dcmBrowser_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.dcmBrowser_root.dcmBrowser_rail{padding-right:0}.dcmBrowser_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.dcmBrowser_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.dcmBrowser_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.dcmBrowser_root:not(.dcmBrowser_rail) .dcmBrowser_sectionHeader{margin-top:2px;margin-right:-4px}.dcmBrowser_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.dcmBrowser_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.dcmBrowser_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.dcmBrowser_searchSlotExpanded{max-width:100%;padding-left:0}.dcmBrowser_headerActions{opacity:1;visibility:visible;max-width:92px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.dcmBrowser_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.dcmBrowser_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.dcmBrowser_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.dcmBrowser_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.dcmBrowser_searchExpanded .dcmBrowser_searchButton{width:28px;height:30px}.dcmBrowser_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.dcmBrowser_searchExpanded .dcmBrowser_searchButton:hover{background:0 0}.dcmBrowser_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.dcmBrowser_searchExpanded .dcmBrowser_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.dcmBrowser_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.dcmBrowser_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.dcmBrowser_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.dcmBrowser_rail .dcmBrowser_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.dcmBrowser_rail .dcmBrowser_headerActions{max-width:none}.dcmBrowser_rail .dcmBrowser_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.dcmBrowser_rail .dcmBrowser_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.dcmBrowser_rail .dcmBrowser_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.dcmBrowser_rail .dcmBrowser_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.dcmBrowser_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.dcmBrowser_rail .dcmBrowser_listArea{margin-left:0;margin-right:0;padding-left:0}.dcmBrowser_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.dcmBrowser_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.dcmBrowser_wide{animation:dcmBrowser_wide-in .2s var(--ds-ease-in-out)}@keyframes dcmBrowser_wide-in{0%{opacity:0}}.dcmBrowser_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.dcmBrowser_flatList>*+*,.dcmBrowser_searchTree>[role=treeitem]+[role=treeitem],.dcmBrowser_groupSection>*+*{margin-top:2px}.dcmBrowser_searchStatus,.dcmBrowser_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.dcmBrowser_searchWarning{color:var(--dsw-alias-label-secondary)}.dcmBrowser_groupSection{position:relative}.dcmBrowser_groupSection+.dcmBrowser_groupSection{margin-top:4px}.dcmBrowser_listTopDropIndicator,.dcmBrowser_workspaceDropBefore:before,.dcmBrowser_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.dcmBrowser_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.dcmBrowser_listTopDropActive>.dcmBrowser_workspaceDropBefore:first-child:before{display:none}.dcmBrowser_workspaceDropBefore:before{top:-8px}.dcmBrowser_workspaceDropAfter:after{bottom:-8px}.dcmBrowser_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.dcmBrowser_groupSection>.dcmBrowser_sessionOverflowButton{margin-top:0}.dcmBrowser_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.dcmBrowser_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.dcmBrowser_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.dcmBrowser_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.dcmBrowser_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.dcmBrowser_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.dcmBrowser_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.dcmBrowser_wide{animation:none}.dcmBrowser_search,.dcmBrowser_sectionLabel,.dcmBrowser_searchSlot,.dcmBrowser_searchInput,.dcmBrowser_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "dcmBrowser_clearButton",
			"deleteAction": "dcmBrowser_deleteAction",
			"deleteStatus": "dcmBrowser_deleteStatus",
			"empty": "dcmBrowser_empty",
			"fade": "dcmBrowser_fade",
			"flatList": "dcmBrowser_flatList",
			"groupSection": "dcmBrowser_groupSection",
			"headerActions": "dcmBrowser_headerActions",
			"headerActionsHidden": "dcmBrowser_headerActionsHidden",
			"iconButton": "dcmBrowser_iconButton",
			"list": "dcmBrowser_list",
			"listArea": "dcmBrowser_listArea",
			"listTopDropActive": "dcmBrowser_listTopDropActive",
			"listTopDropIndicator": "dcmBrowser_listTopDropIndicator",
			"rail": "dcmBrowser_rail",
			"renameError": "dcmBrowser_renameError",
			"renameInput": "dcmBrowser_renameInput",
			"root": "dcmBrowser_root",
			"search": "dcmBrowser_search",
			"searchButton": "dcmBrowser_searchButton",
			"searchExpanded": "dcmBrowser_searchExpanded",
			"searchInput": "dcmBrowser_searchInput",
			"searchSlot": "dcmBrowser_searchSlot",
			"searchSlotExpanded": "dcmBrowser_searchSlotExpanded",
			"searchStatus": "dcmBrowser_searchStatus",
			"searchTree": "dcmBrowser_searchTree",
			"searchWarning": "dcmBrowser_searchWarning",
			"sectionHeader": "dcmBrowser_sectionHeader",
			"sectionLabel": "dcmBrowser_sectionLabel",
			"sectionLabelHidden": "dcmBrowser_sectionLabelHidden",
			"sessionOverflowButton": "dcmBrowser_sessionOverflowButton",
			"treeBody": "dcmBrowser_treeBody",
			"wide": "dcmBrowser_wide",
			"wide-in": "dcmBrowser_wide-in",
			"workspaceDropAfter": "dcmBrowser_workspaceDropAfter",
			"workspaceDropBefore": "dcmBrowser_workspaceDropBefore"
		};
		//#endregion
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
									...
									children: (0, react_jsx_runtime.jsx)("button", {
										...
										onClick: () => { if (typeof window.__DSH_PORTABLE_SETTINGS__?.open === "function") { window.__DSH_PORTABLE_SETTINGS__.open("archived-sessions"); return; } setArchiveError(null); setArchiveManagerOpen(true); },
		...
		*/
		function registerArchiveSettings(ctx, React, ui, dangerClass, options = {}) {
...
registerArchiveSettings(ctx, react, _deepseek_ai_dsh_client_ui_primitives, WorkspaceBrowser_module_css_default.deleteAction);
			...
			const browserInjected = () => ({
				...
				restoreSession: async (sessionId) => {
					...
					const refreshes = await Promise.allSettled([ctx.sessions.refresh(), typeof ctx.workspaces.refresh === "function" ? ctx.workspaces.refresh() : Promise.resolve()]);
  ...
  await this.workspaces.unarchiveSession(sessionId)
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:@deepseek-ai/dsh-client-ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".dcmRows_projectRow,.dcmRows_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.dcmRows_projectRow:hover,.dcmRows_sessionRow:hover,.dcmRows_sessionRow.dcmRows_selected{background:var(--dsw-alias-interactive-bg-hover)}.dcmRows_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.dcmRows_searchResultRow:hover,.dcmRows_searchResultRow.dcmRows_selected{background:var(--dsw-alias-interactive-bg-hover)}.dcmRows_searchResultHeading{align-items:center;min-width:0;display:flex}.dcmRows_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.dcmRows_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.dcmRows_searchResultWorkspace,.dcmRows_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.dcmRows_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.dcmRows_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.dcmRows_projectRow{box-sizing:border-box;align-items:center;height:34px}.dcmRows_projectRow .dcmRows_rowActions{height:20px}.dcmRows_sessionRow{height:32px;animation:dcmRows_row-in .15s var(--ds-ease-in-out);gap:0}.dcmRows_sessionRow .dcmRows_title{margin:0 6px 0 4px}.dcmRows_flatSessionRowWithoutStatus .dcmRows_title{margin-left:0}@keyframes dcmRows_row-in{0%{opacity:0}}.dcmRows_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.dcmRows_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.dcmRows_folderActive{color:var(--dsw-alias-state-business-primary)}.dcmRows_projectRow .dcmRows_chevron{display:none}.dcmRows_projectRow:hover .dcmRows_chevron{display:inline-flex}.dcmRows_projectRow:hover .dcmRows_folder{display:none}.dcmRows_arrow{transition:transform .15s var(--ds-ease-in-out)}.dcmRows_arrowOpen{transform:rotate(90deg)}.dcmRows_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.dcmRows_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.dcmRows_renameInput{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.dcmRows_sessionRow .dcmRows_title{flex:1}.dcmRows_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.dcmRows_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.dcmRows_scheduleIndicator{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex}.dcmRows_searchScheduleIndicator{margin-left:4px;margin-right:0}.dcmRows_dot{flex:none}.dcmRows_rowActions{flex:none;align-items:center;gap:12px;display:none}.dcmRows_projectRow:hover .dcmRows_rowActions,.dcmRows_sessionRow:hover .dcmRows_rowActions,.dcmRows_projectRow.dcmRows_menuOpen .dcmRows_rowActions,.dcmRows_sessionRow.dcmRows_menuOpen .dcmRows_rowActions{display:inline-flex}.dcmRows_sessionRow:hover .dcmRows_time,.dcmRows_sessionRow.dcmRows_menuOpen .dcmRows_time{display:none}.dcmRows_projectRow.dcmRows_menuOpen,.dcmRows_sessionRow.dcmRows_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.dcmRows_sessionRow.dcmRows_dropBefore,.dcmRows_sessionRow.dcmRows_dropAfter{position:relative}.dcmRows_sessionRow.dcmRows_dropBefore:before,.dcmRows_sessionRow.dcmRows_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.dcmRows_sessionRow.dcmRows_dropBefore:before{top:-7px}.dcmRows_sessionRow.dcmRows_dropAfter:after{bottom:-7px}.dcmRows_hoverContent{flex-direction:column;gap:8px;display:flex}.dcmRows_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.dcmRows_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.dcmRows_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.dcmRows_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.dcmRows_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.dcmRows_iconButton:hover{color:var(--dsw-alias-label-primary)}.dcmRows_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.dcmRows_sessionRow,.dcmRows_arrow{transition:none;animation:none}}";
		const tagId$2 = "@deepseek-ai/dsh-client-ui-workspace/Rows.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-workspace";
		...
		var Rows_module_css_default = {
			...
			"row-in": "dcmRows_row-in",
			"rowActions": "dcmRows_rowActions",
			"scheduleIndicator": "dcmRows_scheduleIndicator",
			"searchResultHeading": "dcmRows_searchResultHeading",
			"searchResultMeta": "dcmRows_searchResultMeta",
			"searchResultRow": "dcmRows_searchResultRow",
			"searchResultSnippet": "dcmRows_searchResultSnippet",
			"searchResultTitle": "dcmRows_searchResultTitle",
			"searchResultWorkspace": "dcmRows_searchResultWorkspace",
			"searchScheduleIndicator": "dcmRows_searchScheduleIndicator",
			"selected": "dcmRows_selected",
			"sessionRow": "dcmRows_sessionRow",
			"slot": "dcmRows_slot",
			"time": "dcmRows_time",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:@deepseek-ai/dsh-client-ui-workspace/src/client/rows/WorkspaceBrowser.module.css.mjs
		const css = ".dcmBrowser_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.dcmBrowser_root.dcmBrowser_rail{padding-right:0}.dcmBrowser_iconButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.dcmBrowser_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.dcmBrowser_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.dcmBrowser_root:not(.dcmBrowser_rail) .dcmBrowser_sectionHeader{margin-top:2px;margin-right:-4px}.dcmBrowser_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.dcmBrowser_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.dcmBrowser_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.dcmBrowser_searchSlotExpanded{max-width:100%;padding-left:0}.dcmBrowser_headerActions{opacity:1;visibility:visible;max-width:92px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.dcmBrowser_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.dcmBrowser_search{box-sizing:border-box;corner-shape:round;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.dcmBrowser_searchExpanded{border:.5px solid var(--dsw-alias-border-l4);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.dcmBrowser_searchButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.dcmBrowser_searchExpanded .dcmBrowser_searchButton{width:28px;height:30px}.dcmBrowser_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.dcmBrowser_searchExpanded .dcmBrowser_searchButton:hover{background:0 0}.dcmBrowser_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.dcmBrowser_searchExpanded .dcmBrowser_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.dcmBrowser_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.dcmBrowser_clearButton{corner-shape:round;cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.dcmBrowser_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.dcmBrowser_rail .dcmBrowser_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.dcmBrowser_rail .dcmBrowser_headerActions{max-width:none}.dcmBrowser_rail .dcmBrowser_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.dcmBrowser_rail .dcmBrowser_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.dcmBrowser_rail .dcmBrowser_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.dcmBrowser_rail .dcmBrowser_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.dcmBrowser_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.dcmBrowser_rail .dcmBrowser_listArea{margin-left:0;margin-right:0;padding-left:0}.dcmBrowser_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.dcmBrowser_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.dcmBrowser_wide{animation:dcmBrowser_wide-in .2s var(--ds-ease-in-out)}@keyframes dcmBrowser_wide-in{0%{opacity:0}}.dcmBrowser_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.dcmBrowser_flatList>*+*,.dcmBrowser_searchTree>[role=treeitem]+[role=treeitem],.dcmBrowser_groupSection>*+*{margin-top:2px}.dcmBrowser_searchStatus,.dcmBrowser_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.dcmBrowser_searchWarning{color:var(--dsw-alias-label-secondary)}.dcmBrowser_groupSection{position:relative}.dcmBrowser_groupSection+.dcmBrowser_groupSection{margin-top:4px}.dcmBrowser_listTopDropIndicator,.dcmBrowser_workspaceDropBefore:before,.dcmBrowser_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.dcmBrowser_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.dcmBrowser_listTopDropActive>.dcmBrowser_workspaceDropBefore:first-child:before{display:none}.dcmBrowser_workspaceDropBefore:before{top:-8px}.dcmBrowser_workspaceDropAfter:after{bottom:-8px}.dcmBrowser_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.dcmBrowser_groupSection>.dcmBrowser_sessionOverflowButton{margin-top:0}.dcmBrowser_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.dcmBrowser_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.dcmBrowser_renameInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.dcmBrowser_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.dcmBrowser_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.dcmBrowser_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.dcmBrowser_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.dcmBrowser_wide{animation:none}.dcmBrowser_search,.dcmBrowser_sectionLabel,.dcmBrowser_searchSlot,.dcmBrowser_searchInput,.dcmBrowser_headerActions{transition:none}}";
		const tagId = "@deepseek-ai/dsh-client-ui-workspace/WorkspaceBrowser.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-client-ui-workspace";
...
registerArchiveSettings(ctx, react, _deepseek_ai_dsh_client_ui_primitives, WorkspaceBrowser_module_css_default.deleteAction);
		...
		*/
		...
		/** The flat "In one list" body: every session is one draggable top-level row. */
		function FlatList({ list, sessionIds, useSessionStatus, open, forkSession, onSessionRename, onSessionArchive, onSessionDelete, usePanelInfo, setSessionOrder, revealSessionId, onSessionRevealed, t }) {
			const panelActive = usePanelInfo((info) => info.activePanelId !== null);
			const statuses = useSessionStatus((s) => s);
		...
		* @returns the region element tree.
		*/
		function WorkspaceBrowser({ wide, usePanelInfo, expandSidebar, useSessions, useSessionStatus, useWorkspaces, useStore, actions, startSession, open, renameSession, forkSession, renameWorkspace, deleteWorkspace, insertWorkspaceBefore, archiveSession, deleteSession, createWorkspace, searchSessions, searchResultLimit, useDirectoryFlow, useHostInfo, renderSlot, t }) {
			const home = useHostInfo((info) => info.home);
		...
		*/
		...
		const en = {
			...
			"delete.pending": "Deleting workspace…",
			"menu.fork": "Fork session",
			"archive.open": "Archived sessions",
			"menu.archiveSession": "Archive session",
			"menu.deleteSession": "Delete session",
			"delete.session.title": "Permanently delete session?",
			"delete.session.desc": "The local record for “{name}” will be permanently deleted and cannot be recovered. Running work will be stopped safely before deletion.",
