...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function WorkspaceBrowser({ wide, expandSidebar, useSessions, useWorkspaces, useStore, actions, startSession, open, renameSession, forkSession, renameWorkspace, deleteWorkspace, insertWorkspaceBefore, archiveSession, deleteSession, restoreSession, searchArchivedSessions, openArchivedSettings, insertSessionBefore, createWorkspace, searchSessions, searchResultLimit, useDirectoryFlow, useHostDescription, renderSlot, t }) {
		...
		*/
		function apply(ctx) {
			...
			const browserInjected = () => ({
				...
				openArchivedSettings: (probe = false) => (function openOfficialArchives(ctx, probe = false) {
  try {
