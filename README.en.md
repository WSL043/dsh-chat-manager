...
Use the fixed-version [AGENTS.md](https://raw.githubusercontent.com/WSL043/dsh-chat-manager/v1.3.2/AGENTS.md).
...
Install the target npm version with the same standard DSH command. For v1.3.2:
