...
- Use the fixed v1.5.2-beta.2 package below for DSH 0.1.7-alpha.2; never substitute a moving branch or an unreviewed source.
...
The v1.5.2-beta.2 package is a standard DSH bundle with a `dsh.bundle` profile patch. Its exact package spec is:
...
approach is not the v1.5.2-beta.2 contract. The product is shown to users as **DSH Chat Manager**.
...
2. Its direct package spec is the fixed `dsh-chat-manager@1.5.2-beta.2` npm version above.
