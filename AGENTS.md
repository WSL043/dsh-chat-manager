...
- Use the fixed v1.5.2-beta.5 package below for DSH 0.1.7-rc.2; never substitute a moving branch or an unreviewed source.
...
This prerelease targets DSH 0.1.7-rc.2. Check the target core before installation.
For DSH 0.1.7-rc.1 use the v1.5.2-beta.4 release guide; for 0.1.7-alpha.1 use v1.5.1.

Verify registry publication before running the installation command.

## Fixed package and standard bundle

The v1.5.2-beta.5 package is a standard DSH bundle with a `dsh.bundle` profile patch. Its exact package spec is:
...
approach is not the v1.5.2-beta.5 contract. The product is shown to users as **DSH Chat Manager**.
...
2. Its direct package spec is the fixed `dsh-chat-manager@1.5.2-beta.5` npm version above.
...
On stock DSH 0.1.7-rc.2, keep the official archive page. Enhanced archive search and permanent deletion in Settings require Portable settings integration; native session-menu deletion works without that integration.
