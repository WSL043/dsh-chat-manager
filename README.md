...
Use the fixed-version [AGENTS.md](https://raw.githubusercontent.com/WSL043/dsh-chat-manager/v1.2.1-beta.0/AGENTS.md).
...
Update by rerunning the quick installer or installing the new npm version. For v1.2.1-beta.0:
